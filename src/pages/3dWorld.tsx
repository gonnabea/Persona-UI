    ...
    <div className='[&>*]:select-none'>
      ...
      <ItemInstallPop
          ...
          <>
            <div
              onClick={(e) => {
                ...
                const installItem = items.training_item_1.find((training_item_1) => training_item_1.installed === false)
                if (installItem) {
              ...
              style={{ border: installingModelName === 'training_item_1' ? 'solid 4px #9C7FEF' : '' }}>
              <img
            ...
            <div
              onClick={(e) => {
                ...
                // items.bed_1.installed = false
                // 아직 설치되지 않은 모델을 찾아 설치중 상태로 변경
                const installItem = items.training_item_2.find((training_item_2) => training_item_2.installed === false)
                if (installItem) {
                  installItem.installing = true
                  setInstallingModelName('training_item_2')
                }
              }}
              style={{ border: installingModelName === 'training_item_2' ? 'solid 4px #9C7FEF' : '' }}
              className='flex flex-col items-center p-2 bg-white rounded-lg cursor-pointer'>
              <img
                className='rounded-lg'
                alt='training_item_2'
        ...
        beauties={
          <>
            <div
              style={{ border: installingModelName === 'flower_1' ? 'solid 4px #9C7FEF' : '' }}
              className='flex flex-col items-center p-2 bg-white rounded-lg cursor-pointer'
              onClick={(e) => {
                e.stopPropagation()
                // items.bed_1.installing = true
        ...
        electronics={
          <>
            <div
              style={{ border: installingModelName === 'tv_1' ? 'solid 4px #9C7FEF' : '' }}
              className='flex flex-col items-center p-2 bg-white rounded-lg cursor-pointer'
              onClick={(e) => {
                e.stopPropagation()
            ...
            <div
              style={{ border: installingModelName === 'camera_1' ? 'solid 4px #9C7FEF' : '' }}
              className='flex flex-col items-center p-2 bg-white rounded-lg cursor-pointer'
              onClick={(e) => {
                e.stopPropagation()
                // items.bed_1.installing = true
            ...
            <div
              style={{ border: installingModelName === 'fridge_1' ? 'solid 4px #9C7FEF' : '' }}
              className='flex flex-col items-center p-2 bg-white rounded-lg cursor-pointer'
              onClick={(e) => {
                e.stopPropagation()
                // items.bed_1.installing = true
            ...
            <div
              style={{ border: installingModelName === 'microwave_oven_1' ? 'solid 4px #9C7FEF' : '' }}
              className='flex flex-col items-center p-2 bg-white rounded-lg cursor-pointer'
              onClick={(e) => {
                e.stopPropagation()
                // items.bed_1.installing = true
            ...
            <div
              style={{ border: installingModelName === 'washing_machine_1' ? 'solid 4px #9C7FEF' : '' }}
              className='flex flex-col items-center p-2 bg-white rounded-lg cursor-pointer'
              onClick={(e) => {
                e.stopPropagation()
                // items.bed_1.installing = true
        ...
        furnitures={
          <>
            <div
              style={{ border: installingModelName === 'bed_1' ? 'solid 4px #9C7FEF' : '' }}
              className='flex flex-col items-center p-2 bg-white rounded-lg cursor-pointer'
              onClick={(e) => {
                e.stopPropagation()
                // items.bed_1.installing = true
            ...
            <div
              style={{ border: installingModelName === 'sofa_1' ? 'solid 4px #9C7FEF' : '' }}
              className='flex flex-col items-center p-2 bg-white rounded-lg cursor-pointer'
              onClick={(e) => {
                e.stopPropagation()
            ...
            <div
              style={{ border: installingModelName === 'box_1' ? 'solid 4px #9C7FEF' : '' }}
              className='flex flex-col items-center p-2 bg-white rounded-lg cursor-pointer'
              onClick={(e) => {
                e.stopPropagation()
                // items.bed_1.installing = true
            ...
            <div
              style={{ border: installingModelName === 'coffee_table_1' ? 'solid 4px #9C7FEF' : '' }}
              className='flex flex-col items-center p-2 bg-white rounded-lg cursor-pointer'
              onClick={(e) => {
                e.stopPropagation()
                // items.bed_1.installing = true
            ...
            <div
              style={{ border: installingModelName === 'kitchen_chair_1' ? 'solid 4px #9C7FEF' : '' }}
              className='flex flex-col items-center p-2 bg-white rounded-lg cursor-pointer'
              onClick={(e) => {
                e.stopPropagation()
                // items.bed_1.installing = true
                // items.bed_1.installed = false
                // 아직 설치되지 않은 모델을 찾아 설치중 상태로 변경
                const installItem = items.kitchen_chair_1.find((kitchen_chair_1) => kitchen_chair_1.installed === false)
                if (installItem) {
                  installItem.installing = true
        ...
        exteriors={
          <>
            <div
              style={{ border: installingModelName === 'door_1' ? 'solid 4px #9C7FEF' : '' }}
              className='flex flex-col items-center p-2 bg-white rounded-lg cursor-pointer'
              onClick={(e) => {
                e.stopPropagation()
            ...
            <div
              style={{ border: installingModelName === 'roof_1' ? 'solid 4px #9C7FEF' : '' }}
              className='flex flex-col items-center p-2 bg-white rounded-lg cursor-pointer'
              onClick={(e) => {
                e.stopPropagation()
