...
function WashingMachine1() {
  ...
  //   useEffect(() => {
  //     console.log(items.washing_machine_1)
  //     console.log(glb.scene)
  //     if (items.washing_machine_1.installing === true) {
  //       setSelectedItem(glb.scene)
  //     }
  //   }, [items.washing_machine_1])

  // 가구 설치중일 시 투명하게 보이게 하는 로직.
  //   useEffect(() => {
  //     const installingModel = items.washing_machine_1.find((washing_machine_1) => washing_machine_1.installing === true)
  //     const installingModelIndex = items.washing_machine_1.findIndex((washing_machine_1) => washing_machine_1.installing === true)
  //     if (installingModel) {
  ...
  return (
    <>
      {clonedArr.map((washing_machine_1_scene, index) => {
        if (items.washing_machine_1[index].installing === true || items.washing_machine_1[index].installed === true) {
          return (
            <>
                ...
                <primitive
                  ...
                  onContextMenu={(e) => {
                    ...
                    if (isEditMode) {
                      ...
                      items.washing_machine_1[index].installing = false
                      forceUpdate(updateIndex + 1)
                    }
                  }}
                  onClick={(e) => {
                  ...
                  rotation={items.washing_machine_1[index].rotation}
                  object={washing_machine_1_scene}
                />
              </Suspense>
              {/*  */}(
