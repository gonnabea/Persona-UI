...
function Fridge1() {
  const group = useRef()
  const glb = useGLTF('/models/interior_items/fridge_001.glb')
  ...
  //   useEffect(() => {
  //     const installingModel = items.fridge_1.find((fridge_1) => fridge_1.installing === true)
  //     const installingModelIndex = items.fridge_1.findIndex((fridge_1) => fridge_1.installing === true)
  //     if (installingModel) {
  ...
  return (
    <>
      {clonedArr.map((fridge_1_scene, index) => {
        if (items.fridge_1[index].installing === true || items.fridge_1[index].installed === true) {
          return (
            <>
                ...
                <primitive
                  ...
                  onContextMenu={(e) => {
                    ...
                    if (isEditMode) {
                      ...
                      items.fridge_1[index].installing = false
                      forceUpdate(updateIndex + 1)
                    }
                  }}
                  ...
                  scale={[1, 1, 1]}
                  position={items.fridge_1[index].installing == true ? installingPos : items.fridge_1[index].position}
                  rotation={items.fridge_1[index].rotation}
                  object={fridge_1_scene}
                />
              </Suspense>
              {/*  */}(
