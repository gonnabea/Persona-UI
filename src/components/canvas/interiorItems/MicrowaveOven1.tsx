...
function MicrowaveOven1() {
  const group = useRef()
  const glb = useGLTF('/models/interior_items/microwave_oven_001.glb')
  ...
  const findMousePosition = (e) => {
    ...
    const installingModel = items.microwave_oven_1.find((microwave_oven_1) => microwave_oven_1.installing === true)
  ...
  const findClickedPosition = (e) => {
    ...
    if (raycaster.intersectObjects(scene.children)[0]) {
      ...
      if (groundTarget) {
        ...
        const installingModelState = items.microwave_oven_1.find(
          (microwave_oven_1) => microwave_oven_1.installing === true,
        )
        const installingModelStateIndex = items.microwave_oven_1.findIndex(
          (microwave_oven_1) => microwave_oven_1.installing === true,
        )
  ...
  //   useEffect(() => {
  //     console.log(items.microwave_oven_1)
  //     console.log(glb.scene)
  //     if (items.microwave_oven_1.installing === true) {
  //       setSelectedItem(glb.scene)
  //     }
  //   }, [items.microwave_oven_1])

  // 가구 설치중일 시 투명하게 보이게 하는 로직.
  //   useEffect(() => {
  //     const installingModel = items.microwave_oven_1.find((microwave_oven_1) => microwave_oven_1.installing === true)
  //     const installingModelIndex = items.microwave_oven_1.findIndex((microwave_oven_1) => microwave_oven_1.installing === true)
  //     if (installingModel) {
  ...
  return (
    <>
      {clonedArr.map((microwave_oven_1_scene, index) => {
        if (items.microwave_oven_1[index].installing === true || items.microwave_oven_1[index].installed === true) {
          return (
            <>
              <Suspense key={index} fallback={null}>
                <primitive
                  ...
                  onContextMenu={(e) => {
                    ...
                    if (isEditMode) {
                      // e.stopPropagation()
                      items.microwave_oven_1[index].installed = false
                      items.microwave_oven_1[index].installing = false
                      forceUpdate(updateIndex + 1)
                    }
                  }}
                  ...
                  position={
                    items.microwave_oven_1[index].installing == true
                      ? installingPos
                      : items.microwave_oven_1[index].position
                  }
                  rotation={items.microwave_oven_1[index].rotation}
                  object={microwave_oven_1_scene}
                />
              </Suspense>
              {/*  */}(
                    ...
                    position={
                      items.microwave_oven_1[index].installing == true
                        ...
                        : [
                            ...
                            items.microwave_oven_1[index].position[1] + 2,
                  ...
                  <Html
                    position={
                      items.microwave_oven_1[index].installing == true
                        ...
                        : [
                            items.microwave_oven_1[index].position[0] - 2.5,
                    ...
                    <button
                      onClick={() => {
                        items.microwave_oven_1[index].rotation = [
                          items.microwave_oven_1[index].rotation[0],
                          items.microwave_oven_1[index].rotation[1] + Math.PI / 4,
                          items.microwave_oven_1[index].rotation[2],
                        ]
                        forceUpdate(updateIndex + 1)
                      }}
                      style={{ backgroundColor: 'white', borderRadius: '100%', padding: '10px' }}></button>
                  ...
                  <Html
                    position={
                      items.microwave_oven_1[index].installing == true
                        ...
                        : [
                            items.microwave_oven_1[index].position[0] + 2,
                            items.microwave_oven_1[index].position[1] + 1,
                            items.microwave_oven_1[index].position[2],
                          ]
                    }>
