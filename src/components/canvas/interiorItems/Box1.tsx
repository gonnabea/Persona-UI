...
function Box1() {
  const group = useRef()
  const glb = useGLTF('/models/interior_items/box_01.glb')
  ...
  //   useEffect(() => {
  //     const installingModel = items.box_1.find((box_1) => box_1.installing === true)
  //     const installingModelIndex = items.box_1.findIndex((box_1) => box_1.installing === true)
  //     if (installingModel) {
  ...
  return (
    <>
      {clonedArr.map((box_1_scene, index) => {
        if (items.box_1[index].installing === true || items.box_1[index].installed === true) {
          return (
            <>
                ...
                <primitive
                  ...
                  onContextMenu={(e) => {
                    ...
                    if (isEditMode) {
                      ...
                      items.box_1[index].installing = false
                      forceUpdate(updateIndex + 1)
                    }
                  }}
                  ...
                  scale={[1, 1, 1]}
                  position={items.box_1[index].installing == true ? installingPos : items.box_1[index].position}
                  rotation={items.box_1[index].rotation}
                  object={box_1_scene}
                />
              </Suspense>
              {/*  */}(
