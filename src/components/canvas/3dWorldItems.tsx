  ...
  return (
    <>
      <Suspense fallback={<Loader />}>
        ...
        {/* 지형 콜라이더 */}
        <BoxCollider args={[100, 2, 1]} position={[-38.7878303527832, -0.6001151204109192, -87.49119567871094]} />
        <BoxCollider
          args={[150, 2, 1]}
        ...
        <BoxCollider
          ...
          rotation={[0, 45, 0]}
        />
        <BoxCollider args={[1, 2, 24]} position={[-127.9855499267578, -0.6001151204109192, -75.3402481079101]} />
        <BoxCollider
          args={[12, 2, 1]}
        ...
        <BoxCollider
          ...
          rotation={[0, 10, 0]}
        />
        <BoxCollider args={[1, 1, 20]} position={[-64.93544006347656, -0.6001151204109192, -140.5526123046875]} />
        <BoxCollider
          args={[100, 1, 1]}
          position={[-99.98423767089844, -0.6001151204109192, -128.0631408691406]}
          rotation={[0, 10, 0]}
        />
        <BoxCollider args={[1, 2, 50]} position={[-140.75332641601562, -0.6001151204109192, -75.62220001220703]} />
        <BoxCollider
          args={[1, 2, 80]}
          position={[-130.6601104736328, -0.6001151204109192, -36.623260498046875]}
          rotation={[0, 10, 0]}
        />
        <BoxCollider args={[1, 2, 100]} position={[-96.12845611572266, -0.6001151204109192, 5]} rotation={[0, 45, 0]} />
        <BoxCollider args={[80, 1, 1]} position={[-15.332093238830566, -0.6001151204109192, 30.75225257873535]} />
        <BoxCollider
          args={[100, 2, 1]}
        ...
        <BoxCollider
          ...
          rotation={[0, 45, 0]}
        />
        <BoxCollider args={[50, 2, 1]} position={[140.64149475097656, -0.6001151204109192, -72.2412338256836]} />
        <BoxCollider args={[1, 2, 10]} position={[119.33563232421875, -0.6001151204109192, -67.02662658691406]} />
        <BoxCollider
          args={[20, 2, 1]}
          position={[115.18716430664062, -0.6001151204109192, -53.56449890136719]}
          rotation={[0, 20, 0]}
        />
        <BoxCollider args={[70, 2, 1]} position={[30.11223030090332, -0.6001151204109192, -87.3530502319336]} />
        <BoxCollider
          args={[30, 2, 1]}
        ...
        <BoxCollider
          ...
          rotation={[0, -7, 0]}
        />
        <BoxCollider args={[22, 2, 1]} position={[100.0007553100586, -0.6001151204109192, -45.634246826171875]} />
      </Suspense>
    </>
  )
}
